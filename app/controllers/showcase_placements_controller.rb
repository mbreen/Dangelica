class ShowcasePlacementsController < ApplicationController
  ...
  def index
    @showcase_placements = ShowcasePlacement.all
  ...
  def new
    @showcase_placement = ShowcasePlacement.new
  ...
  def create
    @showcase_placement = ShowcasePlacement.new(params[:showcase_placement])

    respond_to do |format|
      if @showcase_placement.save
        format.html { redirect_to @showcase_placement, notice: 'Showcase placement was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @showcase_placement.update_attributes(params[:showcase_placement])
        format.html { redirect_to @showcase_placement, notice: 'Showcase placement was successfully updated.' }
        format.json { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to showcase_placements_url }
      format.json { head :ok }
    end
  end
end
